...
import { ThemeProvider, useTheme, createTheme, SpeedDialIcon, SpeedDial, SpeedDialAction  } from '@mui/material';
...
const data = [
  ...
  { name: "China", code:"IN" , population:1324171354, size: 3287263, density: 1324171354/3287263 },
  { name: "Italy", code:"IN" , population:1324171354, size: 3287263, density: 1324171354/3287263 },
  { name: "India", code:"IN" , population:1324171354, size: 3287263, density: 1324171354/3287263 },
  { name: "India", code:"IN" , population:1324171354, size: 3287263, density: 1324171354/3287263 },
  { name: "India", code:"IN" , population:1324171354, size: 3287263, density: 1324171354/3287263 },
  { name: "India", code:"IN" , population:1324171354, size: 3287263, density: 1324171354/3287263 },
        ...
        <Table stickyHeader aria-label="sticky table">
          ...
          <TableBody>
            ...
            {data
              ...
              .map((row) => {
                return (
                  <TableRow               onClick={()=>console.log("cart")}
                  hover role="checkbox" tabIndex={-1} key={row.code}>
                    <TableCell>                    
                      <SpeedDial
                        ariaLabel="SpeedDial basic example"
                        icon={<SpeedDialIcon  icon={<DeleteForeverIcon />} openIcon={<EditIcon />} />}
                        direction="left"
                        >
                          {}
                        {actions.map((action) => (
